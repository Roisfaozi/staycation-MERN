                ...
                <div className="row">
                    ...
                    <div className="col-auto mr-5">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                <Button type='link' href='/use-pyments' >Use Payments</Button>
                            </li>
                        </ul>
                    </div>
                    <div className="col-2 mr-5">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <Button type='link' href='/our-career' >Our Careers</Button>
                            </li>
                            <li className="list-group-item">
                                <Button type='link' href='/privacy' >Privacy</Button>
                            </li>
                            <li className="list-group-item">
                                <Button type='link' href='/trems' >Terms & Condition</Button>
                            </li>
                        </ul>
                    </div>
                    <div className="col-3">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                <Button isExternal type='link' href='tel:+62212208 1996' >021 - 2208 - 1996</Button>
                            </li>
                            <li className="list-group-item">
